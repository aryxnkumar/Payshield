...
import {
  LayoutDashboard, AlertCircle, Shield, LogOut, Menu, X,
  ChevronDown, Bell,
} from 'lucide-react';
      ...
      <aside className={`fixed inset-y-0 left-0 z-50 w-64 bg-navy-950 transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="flex h-full flex-col">
          ...
          <div className="mx-3 mb-2">
            <div className="flex items-center gap-2 rounded-lg bg-electric-500/10 px-3 py-2 text-xs font-semibold text-electric-400">
          ...
          <div className="border-t border-navy-800 p-3">
            <div className="rounded-lg bg-navy-900 p-4">
              <p className="text-xs font-medium text-navy-400">Admin Tools</p>
              <p className="mt-1 text-sm text-navy-200">Manage all disputes and customer issues</p>
            </div>
          </div>
        </div>
      </aside>
      ...
      <div className="flex flex-1 flex-col lg:ml-64">
        ...
        <header className="flex h-16 items-center justify-between border-b border-gray-200 bg-white px-6">
          <div className="flex items-center gap-4">
            ...
            <h2 className="text-lg font-semibold text-navy-900">Admin Console</h2>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="relative">
              ...
              >
                <div className="flex h-9 w-9 items-center justify-center rounded-full bg-gradient-to-br from-navy-700 to-navy-900 text-sm font-semibold text-white">
                  {user?.name?.charAt(0).toUpperCase() || 'A'}
                </div>
                <div className="hidden text-left sm:block">
                  <p className="text-sm font-semibold text-navy-900">{user?.name || 'Admin'}</p>
